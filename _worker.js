...
function securityHeaders(request, env = {}) {
  ...
  const csp = [
    ...
    "connect-src 'self' https: wss: http://localhost:8787 http://127.0.0.1:8787 https://static.cloudflareinsights.com",
    "script-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://unpkg.com blob: https://static.cloudflareinsights.com",
