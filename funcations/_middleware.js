...
// Global middleware — intercepts /api/* requests, passes everything else to static files.
// Avoids the [[route]].js double-bracket filename issue on some systems.
...
export async function onRequest(context) {
  ...
  // Pass non-API requests through to static file serving
